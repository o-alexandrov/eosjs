 ...
 * @module API
 */
import { AbiProvider, ActionSerializerType, AuthorityProvider, BinaryAbi, CachedAbi, ContextFreeGroupCallback, Query, QueryConfig, ResourcePayer, SignatureProvider, TransactConfig, Transaction, TransactResult } from './eosjs-api-interfaces';
...
export declare class Api {
    ...
    deserializeTransactionExtensions(data: [number, string][]): {
