...
describe('Chain API Plugin Endpoints', function () {
    ...
    it('validates return type of send_ro_transaction', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    transaction = _a.sent();
                    return [4 /*yield*/, rpc.send_ro_transaction(transaction)];
                case 2:
                    result = _a.sent();
