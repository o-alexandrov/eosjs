...
describe('eosjs-api', function () {
    ...
    describe('Transaction Extensions', function () {
        ...
        it('confirms that a transaction can be fully serialized and deserialized with resource payer', function () { return __awaiter(void 0, void 0, void 0, function () {
            var resourcePayerTrx, serializedResourcePayerTrx, deserializedResourcePayerTrx, _a;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = [__assign({}, resourcePayerTrx)];
                        _b = {};
                        return [4 /*yield*/, api.serializeTransactionExtensions(resourcePayerTrx)];
                    case 1:
                        _b.transaction_extensions = _c.sent();
                        return [4 /*yield*/, api.serializeActions(resourcePayerTrx.actions)];
                    case 2:
                        _b.actions = _c.sent();
                        return [4 /*yield*/, api.serializeActions(resourcePayerTrx.context_free_actions)];
                    case 3:
                        serializedResourcePayerTrx = __assign.apply(void 0, _a.concat([(_b.context_free_actions = _c.sent(), _b)]));
                        ...
                        return [4 /*yield*/, api.deserializeTransactionWithActions(serializedResourcePayerTrx)];
                    case 4:
                        deserializedResourcePayerTrx = _c.sent();
                        deserializedResourcePayerTrx = __assign(__assign({}, deserializedResourcePayerTrx), api.deserializeTransactionExtensions(deserializedResourcePayerTrx.transaction_extensions));
    ...
    describe('sendSignedTransaction', function () {
        it('should use v1 send_transaction', function () { return __awaiter(void 0, void 0, void 0, function () {
            var signatureProvider, chainId, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                                        ...
                                        json: function () { return __awaiter(void 0, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
                                                ...
                                                if (input === '/v1/node/get_supported_apis') {
                                                    return [2 /*return*/, { apis: ['/v1/chain/send_transaction'] }];
                                                }
                        ...
                        rpc = new eosjs_jsonrpc_1.JsonRpc('', { fetch: fetch });
                        signatureProvider = new eosjs_jssig_1.JsSignatureProvider(['5JtUScZK2XEp3g9gh7F8bwtPTRAkASmNrrftmx4AxDKD5K4zDnr']);
                        ...
                        return [4 /*yield*/, api.sendSignedTransaction({ signatures: [], serializedTransaction: serializedTx })];
                    case 1:
                        result = _a.sent();
        ...
        it('should use v2 send_transaction', function () { return __awaiter(void 0, void 0, void 0, function () {
            var signatureProvider, chainId, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                                ...
                                return [2 /*return*/, ({
                                        ...
                                        json: function () { return __awaiter(void 0, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
                                                ...
                                                if (input === '/v1/node/get_supported_apis') {
                                                    return [2 /*return*/, { apis: ['/v2/chain/send_transaction'] }];
                                                }
                                                return [2 /*return*/, 'Failure'];
                                            });
                                        }); },
        ...
        it('should use send_ro_transaction', function () { return __awaiter(void 0, void 0, void 0, function () {
            var signatureProvider, chainId, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, api.sendSignedTransaction({ signatures: [], serializedTransaction: serializedTx }, true, true)];
                    case 1:
                        result = _a.sent();
                        expect(result).toEqual('Success');
                        return [2 /*return*/];
