...
describe('Node JS environment', function () {
    ...
    it('attempts to sign with web crypto and send to nodeos', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (process.env.NODEOS_VER && process.env.NODEOS_VER === 'release/2.0.x')
                        return [2 /*return*/];
                    return [4 /*yield*/, tests.transactWithWebCrypto()];
                case 1:
                    transactionResponse = _a.sent();
                    expect(Object.keys(transactionResponse)).toContain('transaction_id');
                    return [2 /*return*/];
